...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-900 dark:text-white">Create New Class</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-2">Add a new class to the system</p>
    </div>
        ...
        <form action="{{ route('admin.classes.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="4"
                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <select id="delivery_mode" name="delivery_mode" required
                        ...
                        <option value="physical" {{ old('delivery_mode', 'physical') == 'physical' ? 'selected' : '' }}>Physical</option>
                    </select>
                </div>
