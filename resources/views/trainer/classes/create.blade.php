...
<head>
    ...
    <title>Create Class | {{ config('app.name', 'School Portal') }}</title>
...
<body>
    <div class="container">
        ...
        <div class="card">
            <h1><i class="fa-solid fa-plus"></i> Create New Class</h1>
            <p class="subtitle">Set up a new class with a room and a short description for students.</p>
            ...
            <form method="POST" action="{{ route('trainer.classes.store') }}">
                @csrf
                ...
                <button class="btn btn-primary" type="submit">
                    <i class="fa-regular fa-floppy-disk"></i> Create Class
                </button>
            </form>
        </div>
    </div>
