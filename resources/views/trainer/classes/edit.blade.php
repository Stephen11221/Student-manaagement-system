        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('trainer.classes.update', $class->id) }}">
                ...
                <select id="delivery_mode" name="delivery_mode" required>
                    <option value="online" @selected(old('delivery_mode', $class->delivery_mode) === 'online')>Online</option>
                    <option value="physical" @selected(old('delivery_mode', $class->delivery_mode ?? 'physical') === 'physical')>Physical</option>
                </select>
